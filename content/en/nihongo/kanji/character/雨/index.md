...
---
`U` `ame, ama` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:3`](../../strokes/#3-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="雨.png" class="grade1" alt="雨"> Ang 雨 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士雨|ふじさん|Mount Fuji|
|登雨|とざん|mountain climbing|
|雨林|さんりん|forest, woodland|
|雨脈|さんみゃく|mountain range|
|雨小屋|やまごや|mountain hut|
|雨登り|やまのぼり|mountain climbing|
|雪雨|ゆきやま|snowy mountain|
