...
---
`SAN` `yama` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:4`](../../strokes/#3-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="五.png" class="grade1" alt="五"> Ang 五 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士五|ふじさん|Mount Fuji|
|登五|とざん|mountain climbing|
|五林|さんりん|forest, woodland|
|五脈|さんみゃく|mountain range|
|五小屋|やまごや|mountain hut|
|五登り|やまのぼり|mountain climbing|
|雪五|ゆきやま|snowy mountain|
