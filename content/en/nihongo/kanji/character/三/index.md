...
---
`SAN` `mi, mi(tsu), mit(tsu)` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:3`](../../strokes/#3-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="三.png" class="grade1" alt="三"> Ang 三 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士三|ふじさん|Mount Fuji|
|登三|とざん|mountain climbing|
|三林|さんりん|forest, woodland|
|三脈|さんみゃく|mountain range|
|三小屋|やまごや|mountain hut|
|三登り|やまのぼり|mountain climbing|
|雪三|ゆきやま|snowy mountain|
