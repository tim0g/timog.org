...
---
`KA` `hi` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:4`](../../strokes/#4-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="火.png" class="grade1" alt="火"> Ang 火 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士火|ふじさん|Mount Fuji|
|登火|とざん|mountain climbing|
|火林|さんりん|forest, woodland|
|火脈|さんみゃく|mountain range|
|火小屋|やまごや|mountain hut|
|火登り|やまのぼり|mountain climbing|
|雪火|ゆきやま|snowy mountain|
