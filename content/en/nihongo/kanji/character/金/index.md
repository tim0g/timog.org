...
---
`KIN, KON` `kane, kana` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:3`](../../strokes/#3-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="金.png" class="grade1" alt="金"> Ang 金 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|金林|さんりん|forest, woodland|
|金脈|さんみゃく|mountain range|
|金小屋|やまごや|mountain hut|
