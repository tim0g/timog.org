...
---
`NYUU` `i(ru), i(reru), hai(ru)` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:2`](../../strokes/#3-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="入.png" class="grade1" alt="入"> Ang 入 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士入|ふじさん|Mount Fuji|
|登入|とざん|mountain climbing|
|入林|さんりん|forest, woodland|
|入脈|さんみゃく|mountain range|
|入小屋|やまごや|mountain hut|
|入登り|やまのぼり|mountain climbing|
|雪入|ゆきやま|snowy mountain|
