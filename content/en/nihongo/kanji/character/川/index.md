...
---
`SEN` `kawa` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:3`](../../strokes/#3-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="川.png" class="grade1" alt="川"> Ang 川 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士川|ふじさん|Mount Fuji|
|登川|とざん|mountain climbing|
|川林|さんりん|forest, woodland|
|川脈|さんみゃく|mountain range|
|川小屋|やまごや|mountain hut|
|川登り|やまのぼり|mountain climbing|
|雪川|ゆきやま|snowy mountain|
