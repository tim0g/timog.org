...
---
`JUU, JI` `too, to` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:3`](../../strokes/#2-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="十.png" class="grade1" alt="十"> Ang 十 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士十|ふじさん|Mount Fuji|
|登十|とざん|mountain climbing|
|十林|さんりん|forest, woodland|
|十脈|さんみゃく|mountain range|
|十小屋|やまごや|mountain hut|
|十登り|やまのぼり|mountain climbing|
|雪十|ゆきやま|snowy mountain|
