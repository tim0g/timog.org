...
---
`SHIN` `mori` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:12`](../../strokes/#12-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="森.png" class="grade1" alt="森"> Ang 森 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士森|ふじさん|Mount Fuji|
|登森|とざん|mountain climbing|
|森林|さんりん|forest, woodland|
|森脈|さんみゃく|mountain range|
|森小屋|やまごや|mountain hut|
|森登り|やまのぼり|mountain climbing|
|雪森|ゆきやま|snowy mountain|
