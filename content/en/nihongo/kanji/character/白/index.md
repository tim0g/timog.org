...
---
`HAKU, (BYAKU)` `shiro, shira, shiro(i)` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:5`](../../strokes/#5-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="白.png" class="grade1" alt="白"> Ang 白 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士白|ふじさん|Mount Fuji|
|登白|とざん|mountain climbing|
|白林|さんりん|forest, woodland|
|白脈|さんみゃく|mountain range|
|白小屋|やまごや|mountain hut|
|白登り|やまのぼり|mountain climbing|
|雪白|ゆきやま|snowy mountain|
