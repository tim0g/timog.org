...
---
`(SEKI)` `yuu` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:3`](../../strokes/#3-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="夕.png" class="grade1" alt="夕"> Ang 夕 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士夕|ふじさん|Mount Fuji|
|登夕|とざん|mountain climbing|
|夕林|さんりん|forest, woodland|
|夕脈|さんみゃく|mountain range|
|夕小屋|やまごや|mountain hut|
|夕登り|やまのぼり|mountain climbing|
|雪夕|ゆきやま|snowy mountain|
