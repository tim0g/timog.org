...
---
`SA` `hidari` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:5`](../../strokes/#5-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="左.png" class="grade1" alt="左"> Ang 左 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士左|ふじさん|Mount Fuji|
|登左|とざん|mountain climbing|
|左林|さんりん|forest, woodland|
|左脈|さんみゃく|mountain range|
|左小屋|やまごや|mountain hut|
|左登り|やまのぼり|mountain climbing|
|雪左|ゆきやま|snowy mountain|
