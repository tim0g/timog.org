...
---
`SHI` `yo, yo(tsu), yot(tsu), yon` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:5`](../../strokes/#5-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="四.png" class="grade1" alt="四"> Ang 四 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士四|ふじさん|Mount Fuji|
|登四|とざん|mountain climbing|
|四林|さんりん|forest, woodland|
|四脈|さんみゃく|mountain range|
|四小屋|やまごや|mountain hut|
|四登り|やまのぼり|mountain climbing|
|雪四|ゆきやま|snowy mountain|
