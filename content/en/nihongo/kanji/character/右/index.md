...
---
`U, YUU` `migi` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:3`](../../strokes/#3-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="右.png" class="grade1" alt="右"> Ang 右 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士右|ふじさん|Mount Fuji|
|登右|とざん|mountain climbing|
|右林|さんりん|forest, woodland|
|右脈|さんみゃく|mountain range|
|右小屋|やまごや|mountain hut|
|右登り|やまのぼり|mountain climbing|
|雪右|ゆきやま|snowy mountain|
