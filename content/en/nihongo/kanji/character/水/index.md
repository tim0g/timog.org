...
---
`SUI` `mizu` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:4`](../../strokes/#4-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="水.png" class="grade1" alt="水"> Ang 水 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士水|ふじさん|Mount Fuji|
|登水|とざん|mountain climbing|
|水林|さんりん|forest, woodland|
|水脈|さんみゃく|mountain range|
|水小屋|やまごや|mountain hut|
|水登り|やまのぼり|mountain climbing|
|雪水|ゆきやま|snowy mountain|
