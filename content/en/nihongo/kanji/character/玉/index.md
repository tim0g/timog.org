...
---
`GYOKU` `tama` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:5`](../../strokes/#5-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="玉.png" class="grade1" alt="玉"> Ang 玉 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士玉|ふじさん|Mount Fuji|
|登玉|とざん|mountain climbing|
|玉林|さんりん|forest, woodland|
|玉脈|さんみゃく|mountain range|
|玉小屋|やまごや|mountain hut|
|玉登り|やまのぼり|mountain climbing|
|雪玉|ゆきやま|snowy mountain|
