...
---
`ROKU` `mu, mu(tsu), mut(tsu), mui` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:4`](../../strokes/#3-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="六.png" class="grade1" alt="六"> Ang 六 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士六|ふじさん|Mount Fuji|
|登六|とざん|mountain climbing|
|六林|さんりん|forest, woodland|
|六脈|さんみゃく|mountain range|
|六小屋|やまごや|mountain hut|
|六登り|やまのぼり|mountain climbing|
|雪六|ゆきやま|snowy mountain|
