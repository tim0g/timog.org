...
---
`DAI, TAI` `oo, oo(kii), oo(ini)` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:3`](../../strokes/#3-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="大.png" class="grade1" alt="大"> Ang 大 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士大|ふじさん|Mount Fuji|
|登大|とざん|mountain climbing|
|大林|さんりん|forest, woodland|
|大脈|さんみゃく|mountain range|
|大小屋|やまごや|mountain hut|
|大登り|やまのぼり|mountain climbing|
|雪大|ゆきやま|snowy mountain|
