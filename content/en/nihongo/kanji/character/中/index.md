...
---
`CHUU` `naka` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:4`](../../strokes/#3-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="中.png" class="grade1" alt="中"> Ang 中 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士中|ふじさん|Mount Fuji|
|登中|とざん|mountain climbing|
|中林|さんりん|forest, woodland|
|中脈|さんみゃく|mountain range|
|中小屋|やまごや|mountain hut|
|中登り|やまのぼり|mountain climbing|
|雪中|ゆきやま|snowy mountain|
