...
---
`HYAKU` `--` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:3`](../../strokes/#3-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="百.png" class="grade1" alt="百"> Ang 百 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士百|ふじさん|Mount Fuji|
|登百|とざん|mountain climbing|
|百林|さんりん|forest, woodland|
|百脈|さんみゃく|mountain range|
|百小屋|やまごや|mountain hut|
|百登り|やまのぼり|mountain climbing|
|雪百|ゆきやま|snowy mountain|
