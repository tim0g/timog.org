...
---
`--` `kai` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:3`](../../strokes/#3-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="貝.png" class="grade1" alt="貝"> Ang 貝 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士貝|ふじさん|Mount Fuji|
|登貝|とざん|mountain climbing|
|貝林|さんりん|forest, woodland|
|貝脈|さんみゃく|mountain range|
|貝小屋|やまごや|mountain hut|
|貝登り|やまのぼり|mountain climbing|
|雪貝|ゆきやま|snowy mountain|
