...
---
`MEI, MYOU` `namae` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:6`](../../strokes/#6-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="名.png" class="grade1" alt="名"> Ang 名 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士名|ふじさん|Mount Fuji|
|登名|とざん|mountain climbing|
|名林|さんりん|forest, woodland|
|名脈|さんみゃく|mountain range|
|名小屋|やまごや|mountain hut|
|名登り|やまのぼり|mountain climbing|
|雪名|ゆきやま|snowy mountain|
