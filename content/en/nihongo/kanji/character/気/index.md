...
---
`KI, KE` `--` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:6`](../../strokes/#6-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="気.png" class="grade1" alt="気"> Ang 気 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士気|ふじさん|Mount Fuji|
|登気|とざん|mountain climbing|
|気林|さんりん|forest, woodland|
|気脈|さんみゃく|mountain range|
|気小屋|やまごや|mountain hut|
|気登り|やまのぼり|mountain climbing|
|雪気|ゆきやま|snowy mountain|
