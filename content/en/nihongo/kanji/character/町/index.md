...
---
`CHOU` `machi` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:7`](../../strokes/#7-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="町.png" class="grade1" alt="町"> Ang 町 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士町|ふじさん|Mount Fuji|
|登町|とざん|mountain climbing|
|町林|さんりん|forest, woodland|
|町脈|さんみゃく|mountain range|
|町小屋|やまごや|mountain hut|
|町登り|やまのぼり|mountain climbing|
|雪町|ゆきやま|snowy mountain|
