...
---
`SHI, SU` `ko` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:3`](../../strokes/#3-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="子.png" class="grade1" alt="子"> Ang 子 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士子|ふじさん|Mount Fuji|
|登子|とざん|mountain climbing|
|子林|さんりん|forest, woodland|
|子脈|さんみゃく|mountain range|
|子小屋|やまごや|mountain hut|
|子登り|やまのぼり|mountain climbing|
|雪子|ゆきやま|snowy mountain|
