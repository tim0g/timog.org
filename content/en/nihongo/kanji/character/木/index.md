...
---
`BOKU, MOKU` `ki` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:3`](../../strokes/#3-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="木.png" class="grade1" alt="木"> Ang 木 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士木|ふじさん|Mount Fuji|
|登木|とざん|mountain climbing|
|木林|さんりん|forest, woodland|
|木脈|さんみゃく|mountain range|
|木小屋|やまごや|mountain hut|
|木登り|やまのぼり|mountain climbing|
|雪木|ゆきやま|snowy mountain|
