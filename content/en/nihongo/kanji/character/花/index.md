...
---
`KA` `hana` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:7`](../../strokes/#7-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="花.png" class="grade1" alt="花"> Ang 花 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士花|ふじさん|Mount Fuji|
|登花|とざん|mountain climbing|
|花林|さんりん|forest, woodland|
|花脈|さんみゃく|mountain range|
|花小屋|やまごや|mountain hut|
|花登り|やまのぼり|mountain climbing|
|雪花|ゆきやま|snowy mountain|
