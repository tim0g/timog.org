...
---
`SOU` `kusa` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:6`](../../strokes/#6-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="草.png" class="grade1" alt="草"> Ang 草 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士草|ふじさん|Mount Fuji|
|登草|とざん|mountain climbing|
|草林|さんりん|forest, woodland|
|草脈|さんみゃく|mountain range|
|草小屋|やまごや|mountain hut|
|草登り|やまのぼり|mountain climbing|
|雪草|ゆきやま|snowy mountain|
