...
---
`NEN` `toshi` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:6`](../../strokes/#6-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="年.png" class="grade1" alt="年"> Ang 年 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士年|ふじさん|Mount Fuji|
|登年|とざん|mountain climbing|
|年林|さんりん|forest, woodland|
|年脈|さんみゃく|mountain range|
|年小屋|やまごや|mountain hut|
|年登り|やまのぼり|mountain climbing|
|雪年|ゆきやま|snowy mountain|
