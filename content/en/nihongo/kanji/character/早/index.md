...
---
`SOU, SA` `haya(i), haya(maru), haya(meru)` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:6`](../../strokes/#6-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="早.png" class="grade1" alt="早"> Ang 早 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士早|ふじさん|Mount Fuji|
|登早|とざん|mountain climbing|
|早林|さんりん|forest, woodland|
|早脈|さんみゃく|mountain range|
|早小屋|やまごや|mountain hut|
|早登り|やまのぼり|mountain climbing|
|雪早|ゆきやま|snowy mountain|
