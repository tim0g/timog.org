...
---
`BUN, MON` `fumi` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:4`](../../strokes/#4-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="文.png" class="grade1" alt="文"> Ang 文 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士文|ふじさん|Mount Fuji|
|登文|とざん|mountain climbing|
|文林|さんりん|forest, woodland|
|文脈|さんみゃく|mountain range|
|文小屋|やまごや|mountain hut|
|文登り|やまのぼり|mountain climbing|
|雪文|ゆきやま|snowy mountain|
