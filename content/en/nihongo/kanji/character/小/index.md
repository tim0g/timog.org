...
---
`SHOU` `chii(sai), ko, o` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:3`](../../strokes/#3-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="小.png" class="grade1" alt="小"> Ang 小 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士小|ふじさん|Mount Fuji|
|登小|とざん|mountain climbing|
|小林|さんりん|forest, woodland|
|小脈|さんみゃく|mountain range|
|小小屋|やまごや|mountain hut|
|小登り|やまのぼり|mountain climbing|
|雪小|ゆきやま|snowy mountain|
