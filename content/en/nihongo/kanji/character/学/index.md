...
---
`GAKU` `mana(bu)` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:8`](../../strokes/#8-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="学.png" class="grade1" alt="学"> Ang 学 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士学|ふじさん|Mount Fuji|
|登学|とざん|mountain climbing|
|学林|さんりん|forest, woodland|
|学脈|さんみゃく|mountain range|
|学小屋|やまごや|mountain hut|
|学登り|やまのぼり|mountain climbing|
|雪学|ゆきやま|snowy mountain|
