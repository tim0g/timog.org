...
---
`JI` `(aza)` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:6`](../../strokes/#6-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="字.png" class="grade1" alt="字"> Ang 字 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士字|ふじさん|Mount Fuji|
|登字|とざん|mountain climbing|
|字林|さんりん|forest, woodland|
|字脈|さんみゃく|mountain range|
|字小屋|やまごや|mountain hut|
|字登り|やまのぼり|mountain climbing|
|雪字|ゆきやま|snowy mountain|
