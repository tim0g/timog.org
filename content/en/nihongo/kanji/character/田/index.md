...
---
`DEN` `ta` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:5`](../../strokes/#5-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="田.png" class="grade1" alt="田"> Ang 田 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士田|ふじさん|Mount Fuji|
|登田|とざん|mountain climbing|
|田林|さんりん|forest, woodland|
|田脈|さんみゃく|mountain range|
|田小屋|やまごや|mountain hut|
|田登り|やまのぼり|mountain climbing|
|雪田|ゆきやま|snowy mountain|
