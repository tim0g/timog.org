...
---
`RIN` `hayashi` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:3`](../../strokes/#3-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="林.png" class="grade1" alt="林"> Ang 林 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士林|ふじさん|Mount Fuji|
|登林|とざん|mountain climbing|
|林林|さんりん|forest, woodland|
|林脈|さんみゃく|mountain range|
|林小屋|やまごや|mountain hut|
|林登り|やまのぼり|mountain climbing|
|雪林|ゆきやま|snowy mountain|
