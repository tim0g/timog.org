...
---
`CHIKU` `take` [`JLPT:5`](../../jlpt/5/) [`Grade:1`](../../grade/1/) [`Strokes:6`](../../strokes/#6-strokes) `Freq:24`

{{% pageinfo %}}
 <img src="竹.png" class="grade1" alt="竹"> Ang 竹 (kasama ng 川 "kawa" ) ay isa sa mga *kanji* na unang natututunan ng mga bata. Bukod sa madaling isulat ay madali ring matandaan dahil sa may hawig sa bagay na tinutukoy nito (bundok).
...
|--------|---------|---------|
|富士竹|ふじさん|Mount Fuji|
|登竹|とざん|mountain climbing|
|竹林|さんりん|forest, woodland|
|竹脈|さんみゃく|mountain range|
|竹小屋|やまごや|mountain hut|
|竹登り|やまのぼり|mountain climbing|
|雪竹|ゆきやま|snowy mountain|
